import{_ as n,c as a,o as p,ag as e}from"./chunks/framework.D_D2S754.js";const m=JSON.parse('{"title":"JavaScript | 1000个判断条件难道要写了1000个 if ? 一文教你如何实现分支优化","description":"","frontmatter":{},"headers":[],"relativePath":"excellentArticle/2024-06-13/index.md","filePath":"excellentArticle/2024-06-13/index.md","lastUpdated":1718258785000}'),l={name:"excellentArticle/2024-06-13/index.md"};function c(i,s,r,o,t,b){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="javascript-1000个判断条件难道要写了1000个-if-一文教你如何实现分支优化" tabindex="-1">JavaScript | 1000个判断条件难道要写了1000个 if ? 一文教你如何实现分支优化 <a class="header-anchor" href="#javascript-1000个判断条件难道要写了1000个-if-一文教你如何实现分支优化" aria-label="Permalink to &quot;JavaScript | 1000个判断条件难道要写了1000个 if ? 一文教你如何实现分支优化&quot;">​</a></h1><p>最近在网上冲浪时看到了这样一段代码：</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function getUserDescribe(name) {</span></span>
