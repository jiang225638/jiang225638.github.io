import{_ as s,c as n,o as a,a5 as e}from"./chunks/framework.BP9_yO8D.js";const h=JSON.parse('{"title":"10 分钟，速通 JS 性能优化","description":"","frontmatter":{},"headers":[],"relativePath":"excellentArticle/2024-08-23/index.md","filePath":"excellentArticle/2024-08-23/index.md","lastUpdated":1727418873000}'),p={name:"excellentArticle/2024-08-23/index.md"},l=e(`<h1 id="_10-分钟-速通-js-性能优化" tabindex="-1">10 分钟，速通 JS 性能优化 <a class="header-anchor" href="#_10-分钟-速通-js-性能优化" aria-label="Permalink to &quot;10 分钟，速通 JS 性能优化&quot;">​</a></h1><h2 id="_1-内存管理方案" tabindex="-1"><strong>1. 内存管理方案</strong> <a class="header-anchor" href="#_1-内存管理方案" aria-label="Permalink to &quot;**1. 内存管理方案**&quot;">​</a></h2><h3 id="_1-1-全局变量导致内存泄漏问题" tabindex="-1"><strong>1.1 全局变量导致内存泄漏问题</strong> <a class="header-anchor" href="#_1-1-全局变量导致内存泄漏问题" aria-label="Permalink to &quot;**1.1 全局变量导致内存泄漏问题**&quot;">​</a></h3><p>使用全局变量可能会导致内存泄漏，因为它们在程序终止之前不会自动被垃圾回收。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 具有全局变量的内存泄漏示例</span></span>
...
<span class="line"><span>  });</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div>`,44),r=[l];function i(c,o,t,b,u,d){return a(),n("div",null,r)}const g=s(p,[["render",i]]);export{h as __pageData,g as default};
