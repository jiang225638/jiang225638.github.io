import{_ as n,c as s,o as a,a4 as p,cF as e,cG as l,cH as i,cI as r,cJ as c,cK as t,cL as o,cM as b,cN as u,cO as m,cP as d,cQ as h,cR as g,cS as k,cT as f}from"./chunks/framework.Cxu6JU6S.js";const w=JSON.parse('{"title":"古茗前端在 web 地图上的踩坑指南","description":"","frontmatter":{},"headers":[],"relativePath":"excellentArticle/2024-06-14/index.md","filePath":"excellentArticle/2024-06-14/index.md","lastUpdated":1718347891000}'),v={name:"excellentArticle/2024-06-14/index.md"},q=p(`<h1 id="古茗前端在-web-地图上的踩坑指南" tabindex="-1">古茗前端在 web 地图上的踩坑指南 <a class="header-anchor" href="#古茗前端在-web-地图上的踩坑指南" aria-label="Permalink to &quot;古茗前端在 web 地图上的踩坑指南&quot;">​</a></h1><h2 id="背景" tabindex="-1">背景 <a class="header-anchor" href="#背景" aria-label="Permalink to &quot;背景&quot;">​</a></h2><p>古茗是一家茶饮行业的连锁加盟企业，加盟就涉及到开店选址，一家奶茶店能否盈利，点位无疑是很重要的一个因素，如何保证点位的数量、质量，直观分析和感受点位之间的分布合理性、覆盖率、竞争关系，以及如何进行合理规划就成了一个刚性需求场景，而基于高德地图的可视化大盘可以很好的解决这些问题。</p><p>接下来的内容将会从高德地图的使用到一些踩坑经验为小伙伴们分享一些填坑技巧和指南，希望对使用相关技术的小伙伴提供一个参考~</p><h2 id="引入方式" tabindex="-1">引入方式 <a class="header-anchor" href="#引入方式" aria-label="Permalink to &quot;引入方式&quot;">​</a></h2><ul><li>js引入方式</li></ul><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;script src=&quot;https://webapi.amap.com/maps?v=2.0.0&amp;key=您申请的key值&quot;&gt;&lt;/script&gt; </span></span>
