...
<span class="line"><span> }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>});</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br></div></div><ol><li>detectObjects 函数用于执行对象检测。它接收加载的 COCO-SSD 模型作为参数。</li><li>使用 model.detect(video) 对视频中的对象进行检测，返回一个包含对象预测结果的数组。</li><li>使用 predictions.find() 方法查找包含类别为 &#39;person&#39; 的预测结果。</li><li>如果找到了类别为 &#39;person&#39; 的对象，就更新覆盖层的位置和尺寸，以及显示覆盖层；否则隐藏覆盖层。</li></ol><p><strong>通过这种方式，我们可以实现在前端对视频中的人像进行实时捕获，并在画面中标识出人物的位置。</strong></p><p><strong>如果是一张静态图片, 我们需要从用户 拍摄的人脸照片 来完成 人脸识别功能 该如何去做呢?</strong></p><p><strong>详情请看下期。</strong></p><p><strong>图像人脸识别技术</strong></p>`,25)]))}const m=n(l,[["render",i]]);export{u as __pageData,m as default};
