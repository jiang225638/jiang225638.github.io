...
![medium-zoom](/assets/excellentArticle/2024-05-23/640.webp)image.png

**首次请求** 我们主要看图片的请求头跟响应头就行（因为html的缓存会失效）。

![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-1.webp)image.png

![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-2.webp)image.png
...
![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-3.webp)image.png

![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-4.webp)image.png
...
![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-5.webp)image.png

强制刷新后就能看到，我们替换的图片生效了，请求头中也带上了 `Cache-Control: no-cache` 属性。

![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-6.webp)image.png
...
![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-7.webp)image.png

**刷新页面（非强制刷新）**

第二次请求，响应状态码变为 `304`，并在请求头中携带 `If-Modified-Since: Mon, 05 Jun 2023 08:57:17 GMT` 属性，表示浏览器使用缓存文件。

![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-8.webp)image.png

**改变html文件**

把 html 中 的 `Hello World!` 改为 `Web Html`，并刷新页面（非强制刷新），发现响应状态码变为 `200` ，并且更新了页面和响应头的 `Last-Modified` 属性。

![medium-zoom](/assets/excellentArticle/2024-05-23/640-1716447775017-9.webp)image.png
