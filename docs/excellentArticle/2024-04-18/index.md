...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-136.png)
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-137.png)
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-138.png)
...
至于什么时候将`index.vue`文件中的template模块、script模块、style模块编译成js代码，我们在 [通过debug搞清楚.vue文件怎么变成.js文件](https://mp.weixin.qq.com/s?__biz=MzkzMzYzNzMzMQ==&mid=2247483961&idx=1&sn=da58c998ee2c70629603ea08d47de425&scene=21#wechat_redirect)文章中已经讲过了当import加载一个文件时会触发`@vitejs/plugin-vue`包中的`transform`钩子函数，在这个`transform`钩子函数中会将template模块、script模块、style模块编译成js代码。所以在浏览器中拿到的index.vue文件就是经过编译后的js代码了。
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-139.png)compile-progress
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-140.png)
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-141.png)
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-142.png)
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-143.png)
...
![medium-zoom](/assets/excellentArticle/2024-04-18/640-1713444830906-144.png)
