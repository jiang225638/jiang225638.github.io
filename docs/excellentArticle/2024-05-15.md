...
![img](/assets/excellentArticle/2024-05-15/300.png)
...
![medium-zoom](/assets/excellentArticle/2024-05-15/640.webp)
...
![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657668-1.webp)

后续打开该 Chrome 浏览器应用，都是以禁用浏览器同源策略的方式打开。如果设置成功了，打开 Chrome 浏览器会有如下提示：

![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657668-2.webp)
...
![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657668-3.webp)

**「步骤二」**：固定插件到导航栏，并点击启用 CORS Unblock 插件。

![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657668-4.webp)

![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657668-5.webp)
...
![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657668-6.webp)

跨域请求失败

**「启动插件后」**：跨域请求被自动添加了 CORS 配置，请求成功

![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657668-7.webp)
...
![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657669-8.webp)

charles

**「步骤二」**：添加 Rewrite 配置

![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657669-9.webp)

charles

**「步骤三」**：Add 时添加 CORS 配置响应头

![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657669-10.webp)

charles

通过完成上述的三个步骤，我们现在就可以直接访问跨域接口了，可以看到所有的接口响应上都已经被添加了 `Access-Control-Allow-Origin:*` CORS 属性。

![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657669-11.webp)
...
![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657669-12.png)
...
![medium-zoom](/assets/excellentArticle/2024-05-15/640-1715753657669-13.webp)
