...
![medium-zoom](/docs/assets/excellentArticle/2024-05-31/640.webp)

**心跳验证：**

等待一段时间后，我们可以看到ws连接里，前端已经发送了多次心跳数据

![medium-zoom](/docs/assets/excellentArticle/2024-05-31/640-1717119641015-1.webp)

服务端与客户端也一直在进行数据交互

![medium-zoom](/docs/assets/excellentArticle/2024-05-31/640-1717119641015-2.webp)

**断网重连验证：**

可以看到，当我们断开服务端的时候，断网重连被自动触发。
![medium-zoom](/docs/assets/excellentArticle/2024-05-31/640-1717119641015-3.webp)
