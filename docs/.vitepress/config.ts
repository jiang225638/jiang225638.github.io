...
const description = [
  '欢迎来到我的博客',
  '我们并非在年复一年地变老，而是日复一日地焕然一新。诗人-艾米莉·狄金森',
  '允许自己感受焦虑，它正指引你走向更真实的生命。心理学家-欧文·亚隆'
].toString()
...
const teekConfig = defineTeekConfig({
  ...
  docAnalysis: {
    ...
    // ],
    appendInfo: [{ key: 'index', label: '序号', value: 'J' }]
  },
